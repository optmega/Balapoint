...
//        // Hashtag Reference
        ...
        var dict = ["uid": currentUserId ,"photoUrl": photoUrl, "caption": caption, "likeCount": 0, "ratio": ratio, "title": title, "body": body, "time_interval" : date, "hashtag" : hashtag] as [String : Any]
